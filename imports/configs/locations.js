...
export const tiles = {
  ...
  'building-right-roof': {type: 'building-right-roof'},
  'building-front-wall': {type: 'building-front-wall'},
  'house-1': {type: 'house-1'},
  'house-2': {type: 'house-2'},
  'house-3': {type: 'house-3'},
  'house-4': {type: 'house-4'},
  'house-5': {type: 'house-5'},
  'house-6': {type: 'house-6'},
  'house-7': {type: 'house-7'},
  'house-8': {type: 'house-8'},
  'house-9': {type: 'house-9', data: {x: 0, y: 0, name: 'rome', lock: {type: doorConfig.lockTypes.none}}, stats: doorConfig.stats, buildingResources: doorConfig.buildingResources},
  'bar-1': {type: 'bar-1'},
  'bar-2': {type: 'bar-2'},
  'bar-3': {type: 'bar-3'},
  'bar-4': {type: 'bar-4'},
  ...
  'bar-7': {type: 'bar-7'},
  'bar-8': {type: 'bar-8'},
  'bar-9': {type: 'bar-9', data: {x: 0, y: 0, name: 'rome', lock: {type: doorConfig.lockTypes.none}}, stats: doorConfig.stats, buildingResources: doorConfig.buildingResources},
